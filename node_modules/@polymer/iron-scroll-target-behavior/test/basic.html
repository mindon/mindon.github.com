...
suite('basic features', function() {
  ...
  test('toggleScrollListener', function(done) {
    flush(function() {
      ...
      setTimeout(function() {
        assert.isTrue(
            xScroll._scrollHandler.called, '_scrollHandler should be called');
        ...
        setTimeout(function() {
          assert.isFalse(
              xScroll._scrollHandler.called,
              '_scrollHandler should not be called');
          done();
        }, 100);
      }, 100);
    });
...
suite('scrolling region', function() {
  ...
  test('getters', function(done) {
    flush(function() {
      ...
      assert.equal(
          xScrollable._scrollTargetWidth,
          scrollingRegion.offsetWidth,
          '_scrollTargetWidth');
      assert.equal(
          xScrollable._scrollTargetHeight,
          scrollingRegion.offsetHeight,
          '_scrollTargetHeight');
