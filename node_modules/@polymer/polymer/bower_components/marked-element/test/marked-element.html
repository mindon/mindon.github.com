  ...
  <test-fixture id="Sanitizer">
    <template>
      <marked-element sanitize>
        <div id="output" slot="markdown-html"></div>
        <script type="text/markdown">
[Link](https://url.com" onclick="alert(1)")
<a href="https://url.com" onclick="alert(1)">Link</a>
```html
<a href="https://url.com" onclick="alert(1)">Link</a>
```
        </script>
  ...
  <script>
    ...
    suite('<marked-element> with custom sanitizer', function() {
      ...
      test('takes custom sanitizer', function() {
        ...
        proofElement.innerHTML = '<p><a href="https://url.com&quot; onclick=&quot;alert(1">Link</a>")\n<a href="https://url.com">Link</a></p>\n<pre><code class="lang-html">&lt;a href="https://url.com" onclick="alert(1)"&gt;Link&lt;/a&gt;\n</code></pre>\n';
    ...
    suite('<marked-element> with custom renderer', function() {
      ...
      test('takes custom link renderer', function() {
        ...
        proofElement.innerHTML = '<a href="https://url.com" target="_blank">Link</a>';
        expect(outputElement.innerHTML).to.include(proofElement.innerHTML);
      });
    });
