...
<body>
  ...
  <test-fixture id="RealPost">
    <template>
      <iron-ajax method="POST" url="https://httpbin.org/post"></iron-ajax>
    </template>
  </test-fixture>
  <test-fixture id="Delay">
    <template>
      <iron-ajax url="https://httpbin.org/delay/1"></iron-ajax>
    </template>
  </test-fixture>
  <test-fixture id="Bubbles">
    <template>
      <iron-ajax url="https://httpbin.org/post" method="POST" bubbles></iron-ajax>
