(function(window, document, exportName, undefined) {
    ...
    function preventMouseEvents(ev) {
        if(window.touchEmulatorOff) return;
        ev.preventDefault();
        ev.stopPropagation();
    }
    ...
    function onMouse(touchType) {
        return function(ev) {
            var eob = eventTarget || ev.target || ev.srcElement;
            if(eob && (offStyle.test(eob.getAttribute('class')) || (eob.parentNode && offStyle.test(eob.parentNode.getAttribute('class')))))
                return true;
            ...
            if(eventTarget) triggerTouch(touchType, ev);
